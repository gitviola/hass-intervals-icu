...
HRV_BASELINE_SEASONED_WINDOW_DAYS = 56
HRV_BASELINE_MAX_WINDOW_DAYS = 66
HRV_BASELINE_MIN_SAMPLES = 12
HRV_BASELINE_DENSE_SAMPLE_THRESHOLD = 20
HRV_BASELINE_SEASONED_SAMPLE_THRESHOLD = 42
HRV_BASELINE_LAG_DAYS = 6
HRV_BASELINE_LOWER_PERCENTILE = 32.0
HRV_BASELINE_UPPER_PERCENTILE = 97.0
HRV_BASELINE_SEASONED_LOWER_PERCENTILE = 32.0
HRV_BASELINE_SEASONED_UPPER_PERCENTILE = 95.0
HRV_BASELINE_RECOVERY_LOWER_PERCENTILE = 33.0
HRV_BASELINE_RECOVERY_UPPER_PERCENTILE = 95.0
HRV_LOW_CUTOFF_MIN_DELTA_MS = 2.0
HRV_LOW_CUTOFF_RANGE_FACTOR = 0.25
HRV_STATUS_BOOTSTRAP_DAYS = 120
HRV_POOR_PERSISTENCE_DAYS = 7
HRV_STATUS_HISTORY_DAYS = 28
